...
<center>
<p>
    <img src="../images/self_driving_car.png" width=500px height=500px>
...
* **Stability Control**
    ...
    - Solution: I implemented a 30-pixel tolerance zone in the steering algorithm. If the target is within 30 pixels of the center, the software commands the car to move straight, resulting in a smooth, stable trajectory.


* **Safety Mechanisms**
    - Solution: I integrated HC-SR04 ultrasonic sensors to constantly monitor the gap between vehicles. I wrote a safety interrupt function that triggers an automatic emergency stop if the distance falls below 20cm, overriding all other navigation commands.
...
<center>
<object data="../pdf/self_driving_car.pdf" type="application/pdf" width="700px" height="700px">
